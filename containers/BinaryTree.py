...
It is crucial to get these implemented correctly in
order to be able to implement the other data structures.
'''
...
class BinaryTree():
    ...
    def print_tree(self, traversal_type):
        ...
        All three of these traversals are implemented for you as
        a reference on how to write recursive functions on
    ...
    def to_list(self, traversal_type):
        ...
        i       contents = []
        if traversal_type == 'preorder':
            self.__preorder_helper(self.root, contents)
        elif traversal_type == 'inorder':
            self.__inorder_helper(self.root, contents)
        ...
        we can always #print the returned results if we need
        to visualize them.
    ...
    def __len__helper(node):
        ...
        # print("type(node.left)=", type(node.left))
        # print("type(node.right)=", type(node.right))
        if node.left:
    ...
    def height(self):
        ...
        Recall that the height is the maximum length from the root
        to a leaf node.
